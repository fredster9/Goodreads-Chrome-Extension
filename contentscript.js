...
function returnResults(gr_to_read_array) {
    ...
    for (var i = 0; i < books.length; i++) {
        ...
        if (book_obj.e_available === true) {
            ...
            e_text_contents = "Ebook \u23F8 " + book_obj.e_pplWaiting + 
                ' people, est ' + book_obj.e_estWaitDays + ' days';
        }
        else {
            e_text_contents = 'Ebook \u274C';
        }
        ...
        if (book_obj.a_available === true) {
            ...
            a_text_contents = "Audiobook \u23F8 " + book_obj.a_pplWaiting + 
                ' people, est ' + book_obj.a_estWaitDays + ' days';
        }
        else {
            a_text_contents = 'Audiobook \u274C';
        }
